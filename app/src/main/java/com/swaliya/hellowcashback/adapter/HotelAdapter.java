...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.ViewHolder> {
    ...
    private List<AvailableHotel> superHeroes;
    String getid;

    public HotelAdapter(List<AvailableHotel> superHeroes, Context context) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final AvailableHotel m = superHeroes.get(position);
        holder.textViewId.setText("Time : " + m.getHotelAddress());
